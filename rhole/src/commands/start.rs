use crate::{
    ...
    models::{GraphQLState, RouterState, ServerConfig},
};
...
use std::{io::BufReader, net::SocketAddr, path::PathBuf, sync::Arc, time::SystemTime};
...
pub async fn start(debug: bool, config_path: PathBuf, no_update_config: bool) -> Result<()> {
